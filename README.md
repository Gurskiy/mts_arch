...
|:-------------------------|:-------------------|
| ПАО МТС               | - Реклама бренда, привлечение специалистов |
| Докладчики            | - Развитие собственного бренда |
| Администраторы        | - Выбор интересныx докладов, модерация контента  |
| Слушатели             | - Потребление контента   |
